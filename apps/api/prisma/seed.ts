...
async function main(): Promise<void> {
  ...
  const items = [
    ...
    { code: 'HSE_PERMIS', label: 'Permis, assurance et contrôle technique en cours de validité', phase: OperationPhase.PRE_CHARGEMENT, level: HseControlLevel.BLOCKING, requiresPhoto: true, displayOrder: 10 },
    { code: 'HSE_EPI', label: 'EPI complets portés par l\'équipe', phase: OperationPhase.PRE_CHARGEMENT, level: HseControlLevel.BLOCKING, requiresPhoto: true, displayOrder: 11 },
    { code: 'HSE_EXTINCTEURS', label: 'Extincteurs présents, accessibles et vérifiés', phase: OperationPhase.PRE_CHARGEMENT, level: HseControlLevel.BLOCKING, requiresPhoto: true, displayOrder: 12 },
    { code: 'HSE_KIT_DEVERSEMENT', label: 'Kit anti-déversement à bord', phase: OperationPhase.PRE_CHARGEMENT, level: HseControlLevel.MANDATORY, requiresPhoto: true, displayOrder: 13 },
    { code: 'HSE_FUITE', label: 'Absence de fuite constatée', phase: OperationPhase.PRE_CHARGEMENT, level: HseControlLevel.BLOCKING, displayOrder: 14 },
    { code: 'HSE_BRIEFING', label: 'Briefing sécurité réalisé', phase: OperationPhase.PRE_CHARGEMENT, level: HseControlLevel.MANDATORY, requiresSignature: true, displayOrder: 15 },
    { code: 'CHG_AUTORISATION', label: 'Autorisation de chargement obtenue', phase: OperationPhase.CHARGEMENT, level: HseControlLevel.BLOCKING, displayOrder: 20 },
    { code: 'CHG_COMPARTIMENTS', label: 'Contrôle du produit et des compartiments', phase: OperationPhase.CHARGEMENT, level: HseControlLevel.BLOCKING, requiresPhoto: true, displayOrder: 21 },
    { code: 'CHG_JAUGEAGE', label: 'Jaugeage initial, volume et température relevés', phase: OperationPhase.CHARGEMENT, level: HseControlLevel.BLOCKING, requiresValue: true, valueLabel: 'Volume chargé (L) et température (°C)', displayOrder: 22 },
    { code: 'CHG_SCELLES', label: 'Scellés posés et numéros enregistrés', phase: OperationPhase.CHARGEMENT, level: HseControlLevel.BLOCKING, requiresPhoto: true, requiresValue: true, valueLabel: 'Numéros de scellés', displayOrder: 23 },
    ...
    { code: 'LIV_SECURISATION', label: 'Site sécurisé et balisé', phase: OperationPhase.DECHARGEMENT, level: HseControlLevel.BLOCKING, requiresPhoto: true, displayOrder: 40 },
    { code: 'LIV_SCELLES', label: 'Contrôle des scellés à l\'arrivée', phase: OperationPhase.DECHARGEMENT, level: HseControlLevel.BLOCKING, requiresPhoto: true, displayOrder: 41 },
    { code: 'LIV_VOLUME', label: 'Volume livré et température relevés contradictoirement', phase: OperationPhase.DECHARGEMENT, level: HseControlLevel.BLOCKING, requiresValue: true, valueLabel: 'Volume livré (L) et température (°C)', displayOrder: 42 },
    { code: 'LIV_BON', label: 'Bon de livraison signé par le client', phase: OperationPhase.DECHARGEMENT, level: HseControlLevel.BLOCKING, requiresSignature: true, displayOrder: 43 },
    { code: 'CLO_HSE_FINAL', label: 'Contrôle HSE final', phase: OperationPhase.CLOTURE, level: HseControlLevel.BLOCKING, displayOrder: 50 },
    { code: 'CLO_INCIDENT', label: 'Incident ou quasi-accident à déclarer ?', phase: OperationPhase.CLOTURE, level: HseControlLevel.MANDATORY, displayOrder: 51 },
  ];
