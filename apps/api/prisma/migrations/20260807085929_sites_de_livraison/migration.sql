-- AlterTable
ALTER TABLE "partner_sites" ADD COLUMN     "delivery_site_id" UUID;
...
CREATE TABLE "delivery_sites" (
    ...
    CONSTRAINT "delivery_sites_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "site_requirement_types" (
    "id" UUID NOT NULL,
    ...
    CONSTRAINT "site_requirement_types_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "delivery_site_requirements" (
    "id" UUID NOT NULL,
    ...
    CONSTRAINT "delivery_site_requirements_pkey" PRIMARY KEY ("id")
);

-- CreateIndex
CREATE UNIQUE INDEX "delivery_sites_code_key" ON "delivery_sites"("code");

-- CreateIndex
CREATE INDEX "delivery_sites_is_active_city_idx" ON "delivery_sites"("is_active", "city");

-- CreateIndex
CREATE UNIQUE INDEX "site_requirement_types_code_key" ON "site_requirement_types"("code");

-- CreateIndex
CREATE INDEX "delivery_site_requirements_site_id_is_active_idx" ON "delivery_site_requirements"("site_id", "is_active");

-- CreateIndex
CREATE UNIQUE INDEX "delivery_site_requirements_site_id_type_id_key" ON "delivery_site_requirements"("site_id", "type_id");

-- AddForeignKey
ALTER TABLE "delivery_site_requirements" ADD CONSTRAINT "delivery_site_requirements_site_id_fkey" FOREIGN KEY ("site_id") REFERENCES "delivery_sites"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "delivery_site_requirements" ADD CONSTRAINT "delivery_site_requirements_type_id_fkey" FOREIGN KEY ("type_id") REFERENCES "site_requirement_types"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "partner_sites" ADD CONSTRAINT "partner_sites_delivery_site_id_fkey" FOREIGN KEY ("delivery_site_id") REFERENCES "delivery_sites"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
