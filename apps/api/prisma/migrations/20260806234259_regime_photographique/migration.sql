-- CreateEnum
CREATE TYPE "hse_photo_policy" AS ENUM ('FORBIDDEN', 'OPTIONAL', 'REQUIRED');

-- AlterTable
ALTER TABLE "hse_checklist_items" ADD COLUMN     "photo_policy" "hse_photo_policy" NOT NULL DEFAULT 'OPTIONAL';
