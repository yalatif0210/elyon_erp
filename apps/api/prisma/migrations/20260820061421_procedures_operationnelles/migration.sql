...
-- CreateIndex
CREATE UNIQUE INDEX "operational_procedures_operation_type_id_key" ON "operational_procedures"("operation_type_id");

-- AddForeignKey
ALTER TABLE "operational_procedures" ADD CONSTRAINT "operational_procedures_operation_type_id_fkey" FOREIGN KEY ("operation_type_id") REFERENCES "operation_types"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "operational_procedures" ADD CONSTRAINT "operational_procedures_updated_by_id_fkey" FOREIGN KEY ("updated_by_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
