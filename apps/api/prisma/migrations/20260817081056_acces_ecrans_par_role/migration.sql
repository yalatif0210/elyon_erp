...
-- CreateEnum
CREATE TYPE "screen_access_override" AS ENUM ('VISIBLE', 'MASQUE');
...
CREATE TABLE "role_screen_access" (
    ...
    "override" "screen_access_override" NOT NULL,
    "updated_by_id" UUID,
...
-- CreateIndex
CREATE UNIQUE INDEX "role_screen_access_role_screen_key_key" ON "role_screen_access"("role", "screen_key");
