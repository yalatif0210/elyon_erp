...
CREATE TABLE "operation_types" (
    ...
    "default_risk_level" "hse_risk_level",
...
-- CreateTable
CREATE TABLE "operation_type_assignments" (
    "id" UUID NOT NULL,
    ...
    CONSTRAINT "operation_type_assignments_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "_ChecklistOperationTypes" (
    "A" UUID NOT NULL,
    "B" UUID NOT NULL
);
...
-- CreateIndex
CREATE INDEX "operation_types_is_active_display_order_idx" ON "operation_types"("is_active", "display_order");

-- CreateIndex
CREATE INDEX "operation_type_assignments_operation_id_sequence_idx" ON "operation_type_assignments"("operation_id", "sequence");

-- CreateIndex
CREATE UNIQUE INDEX "operation_type_assignments_operation_id_operation_type_id_key" ON "operation_type_assignments"("operation_id", "operation_type_id");

-- CreateIndex
CREATE UNIQUE INDEX "_ChecklistOperationTypes_AB_unique" ON "_ChecklistOperationTypes"("A", "B");

-- CreateIndex
CREATE INDEX "_ChecklistOperationTypes_B_index" ON "_ChecklistOperationTypes"("B");

-- AddForeignKey
ALTER TABLE "operation_type_assignments" ADD CONSTRAINT "operation_type_assignments_operation_id_fkey" FOREIGN KEY ("operation_id") REFERENCES "operations"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "operation_type_assignments" ADD CONSTRAINT "operation_type_assignments_operation_type_id_fkey" FOREIGN KEY ("operation_type_id") REFERENCES "operation_types"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ChecklistOperationTypes" ADD CONSTRAINT "_ChecklistOperationTypes_A_fkey" FOREIGN KEY ("A") REFERENCES "hse_checklist_templates"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ChecklistOperationTypes" ADD CONSTRAINT "_ChecklistOperationTypes_B_fkey" FOREIGN KEY ("B") REFERENCES "operation_types"("id") ON DELETE CASCADE ON UPDATE CASCADE;
