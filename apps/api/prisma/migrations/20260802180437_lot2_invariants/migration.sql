-- AlterTable
ALTER TABLE "deals" ADD COLUMN     "supplier_price_id" UUID;

-- AlterTable
ALTER TABLE "supplier_invoices" ADD COLUMN     "deal_id" UUID;

-- CreateIndex
CREATE INDEX "supplier_invoices_deal_id_idx" ON "supplier_invoices"("deal_id");

-- AddForeignKey
ALTER TABLE "deals" ADD CONSTRAINT "deals_supplier_price_id_fkey" FOREIGN KEY ("supplier_price_id") REFERENCES "supplier_prices"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "supplier_invoices" ADD CONSTRAINT "supplier_invoices_deal_id_fkey" FOREIGN KEY ("deal_id") REFERENCES "deals"("id") ON DELETE SET NULL ON UPDATE CASCADE;
