-- AlterTable
ALTER TABLE "measurement_records" ADD COLUMN     "discharged_observed_volume" DECIMAL(18,6),
ADD COLUMN     "discharged_temp_c" DECIMAL(6,2),
ADD COLUMN     "discharged_vcf" DECIMAL(9,6),
ADD COLUMN     "loaded_observed_volume" DECIMAL(18,6),
ADD COLUMN     "loaded_temp_c" DECIMAL(6,2),
ADD COLUMN     "loaded_vcf" DECIMAL(9,6);
