-- CreateEnum
CREATE TYPE "fiscal_year_status" AS ENUM ('PLANNED', 'OPEN', 'CLOSED');

-- CreateEnum
CREATE TYPE "forecast_kind" AS ENUM ('BUDGET', 'REVISION');
...
CREATE TABLE "fiscal_years" (
    ...
    "status" "fiscal_year_status" NOT NULL DEFAULT 'PLANNED',
...
CREATE TABLE "financing_rates" (
    ...
    "carrying_days_per_year" SMALLINT NOT NULL DEFAULT 360,
    "source" VARCHAR(240),
...
-- CreateTable
CREATE TABLE "fixed_cost_budgets" (
    "id" UUID NOT NULL,
    "fiscal_year_id" UUID NOT NULL,
    ...
    CONSTRAINT "fixed_cost_budgets_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "sales_forecasts" (
    ...
    "forecast_volume" DECIMAL(18,4) NOT NULL,
    "uom" "unit_of_measure" NOT NULL,
    "reference_price" DECIMAL(18,4) NOT NULL,
    "currency_code" CHAR(3) NOT NULL,
    "kind" "forecast_kind" NOT NULL DEFAULT 'BUDGET',
    "version" SMALLINT NOT NULL DEFAULT 1,
    "is_current" BOOLEAN NOT NULL DEFAULT true,
    "notes" VARCHAR(500),
    "author_id" UUID,
...
-- CreateIndex
CREATE INDEX "financing_rates_fiscal_year_id_is_current_idx" ON "financing_rates"("fiscal_year_id", "is_current");

-- CreateIndex
CREATE UNIQUE INDEX "financing_rates_fiscal_year_id_version_key" ON "financing_rates"("fiscal_year_id", "version");

-- CreateIndex
CREATE INDEX "fixed_cost_budgets_fiscal_year_id_is_current_idx" ON "fixed_cost_budgets"("fiscal_year_id", "is_current");

-- CreateIndex
CREATE INDEX "sales_forecasts_fiscal_year_id_is_current_idx" ON "sales_forecasts"("fiscal_year_id", "is_current");

-- CreateIndex
CREATE UNIQUE INDEX "sales_forecasts_fiscal_year_id_segment_product_id_month_ind_key" ON "sales_forecasts"("fiscal_year_id", "segment", "product_id", "month_index", "kind", "version");

-- AddForeignKey
ALTER TABLE "fiscal_years" ADD CONSTRAINT "fiscal_years_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "financing_rates" ADD CONSTRAINT "financing_rates_fiscal_year_id_fkey" FOREIGN KEY ("fiscal_year_id") REFERENCES "fiscal_years"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "financing_rates" ADD CONSTRAINT "financing_rates_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "fixed_cost_budgets" ADD CONSTRAINT "fixed_cost_budgets_fiscal_year_id_fkey" FOREIGN KEY ("fiscal_year_id") REFERENCES "fiscal_years"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "fixed_cost_budgets" ADD CONSTRAINT "fixed_cost_budgets_currency_code_fkey" FOREIGN KEY ("currency_code") REFERENCES "currencies"("code") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "fixed_cost_budgets" ADD CONSTRAINT "fixed_cost_budgets_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "sales_forecasts" ADD CONSTRAINT "sales_forecasts_fiscal_year_id_fkey" FOREIGN KEY ("fiscal_year_id") REFERENCES "fiscal_years"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "sales_forecasts" ADD CONSTRAINT "sales_forecasts_currency_code_fkey" FOREIGN KEY ("currency_code") REFERENCES "currencies"("code") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "sales_forecasts" ADD CONSTRAINT "sales_forecasts_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
SELECT ex.year                                          AS exercice,
       ...
       m.marge_unitaire,
       m.volume_realise,
       (f.postes > 0 AND m.marge_unitaire IS NOT NULL AND m.marge_unitaire > 0)
                                                        AS calculable,
       CASE
         WHEN f.postes = 0
