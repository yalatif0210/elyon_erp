...
-- AlterEnum
ALTER TYPE "unit_of_measure" ADD VALUE 'FORFAIT';

-- AlterTable
ALTER TABLE "cost_pools" ALTER COLUMN "variability" SET DEFAULT 'FIXED';

-- AlterTable
ALTER TABLE "deals" ALTER COLUMN "transport_mode" DROP NOT NULL;

-- AlterTable
ALTER TABLE "products" ADD COLUMN     "is_service" BOOLEAN NOT NULL DEFAULT false,
ALTER COLUMN "reference_density_15" DROP NOT NULL;
