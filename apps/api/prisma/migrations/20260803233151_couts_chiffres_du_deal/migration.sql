...
CREATE TABLE "deal_cost_lines" (
    ...
    CONSTRAINT "deal_cost_lines_pkey" PRIMARY KEY ("id")
);

-- CreateIndex
CREATE INDEX "deal_cost_lines_deal_id_idx" ON "deal_cost_lines"("deal_id");

-- CreateIndex
CREATE UNIQUE INDEX "deal_cost_lines_deal_id_cost_post_id_key" ON "deal_cost_lines"("deal_id", "cost_post_id");

-- AddForeignKey
ALTER TABLE "deal_cost_lines" ADD CONSTRAINT "deal_cost_lines_deal_id_fkey" FOREIGN KEY ("deal_id") REFERENCES "deals"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "deal_cost_lines" ADD CONSTRAINT "deal_cost_lines_cost_post_id_fkey" FOREIGN KEY ("cost_post_id") REFERENCES "cost_posts"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "deal_cost_lines" ADD CONSTRAINT "deal_cost_lines_supplier_id_fkey" FOREIGN KEY ("supplier_id") REFERENCES "partners"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "deal_cost_lines" ADD CONSTRAINT "deal_cost_lines_currency_code_fkey" FOREIGN KEY ("currency_code") REFERENCES "currencies"("code") ON DELETE RESTRICT ON UPDATE CASCADE;
