...
-- AlterTable
ALTER TABLE "margin_thresholds" ADD COLUMN     "is_active" BOOLEAN NOT NULL DEFAULT true;

-- AlterTable
ALTER TABLE "ullage_tolerances" ADD COLUMN     "is_active" BOOLEAN NOT NULL DEFAULT true;
