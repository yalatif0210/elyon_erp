-- AlterTable
ALTER TABLE "operation_hse_check_items" ADD COLUMN     "source_template_id" UUID,
ADD COLUMN     "source_template_version" SMALLINT;

-- AlterTable
ALTER TABLE "operation_hse_checks" ALTER COLUMN "template_id" DROP NOT NULL,
ALTER COLUMN "template_version" DROP NOT NULL;

-- AddForeignKey
ALTER TABLE "operation_hse_check_items" ADD CONSTRAINT "operation_hse_check_items_source_template_id_fkey" FOREIGN KEY ("source_template_id") REFERENCES "hse_checklist_templates"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
