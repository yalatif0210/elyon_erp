...
-- CreateEnum
CREATE TYPE "quotation_request_status" AS ENUM ('NEW', 'IN_REVIEW', 'CONVERTED', 'DECLINED');
...
CREATE TABLE "quotation_requests" (
    ...
    "desired_volume" DECIMAL(18,6) NOT NULL,
    "uom" "unit_of_measure" NOT NULL,
    "desired_delivery_date" DATE,
    "message" VARCHAR(2000),
    "status" "quotation_request_status" NOT NULL DEFAULT 'NEW',
...
-- CreateIndex
CREATE UNIQUE INDEX "quotation_requests_converted_deal_id_key" ON "quotation_requests"("converted_deal_id");

-- CreateIndex
CREATE INDEX "quotation_requests_partner_id_status_idx" ON "quotation_requests"("partner_id", "status");

-- CreateIndex
CREATE INDEX "quotation_requests_status_created_at_idx" ON "quotation_requests"("status", "created_at");

-- AddForeignKey
ALTER TABLE "quotation_requests" ADD CONSTRAINT "quotation_requests_partner_id_fkey" FOREIGN KEY ("partner_id") REFERENCES "partners"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "quotation_requests" ADD CONSTRAINT "quotation_requests_submitted_by_portal_user_id_fkey" FOREIGN KEY ("submitted_by_portal_user_id") REFERENCES "portal_users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "quotation_requests" ADD CONSTRAINT "quotation_requests_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "quotation_requests" ADD CONSTRAINT "quotation_requests_converted_deal_id_fkey" FOREIGN KEY ("converted_deal_id") REFERENCES "deals"("id") ON DELETE SET NULL ON UPDATE CASCADE;
