...
-- CreateEnum
CREATE TYPE "invoice_payment_method" AS ENUM ('CASH', 'CARD', 'CHECK', 'MOBILE_MONEY', 'TRANSFER', 'DEFERRED');

-- AlterTable
ALTER TABLE "cost_pools" ALTER COLUMN "variability" SET DEFAULT 'FIXED';

-- AlterTable
ALTER TABLE "invoices" ADD COLUMN     "payment_method" "invoice_payment_method";

-- AlterTable
ALTER TABLE "partners" ADD COLUMN     "is_government_institution" BOOLEAN NOT NULL DEFAULT false;
