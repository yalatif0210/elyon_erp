...
-- CreateIndex
CREATE INDEX "company_accreditations_type_expiry_date_idx" ON "company_accreditations"("type", "expiry_date");

-- AddForeignKey
ALTER TABLE "company_accreditations" ADD CONSTRAINT "company_accreditations_document_id_fkey" FOREIGN KEY ("document_id") REFERENCES "documents"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "company_accreditations" ADD CONSTRAINT "company_accreditations_recorded_by_id_fkey" FOREIGN KEY ("recorded_by_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
