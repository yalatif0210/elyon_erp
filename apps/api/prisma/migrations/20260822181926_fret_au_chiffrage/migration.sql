...
-- DropForeignKey
ALTER TABLE "operation_assignments" DROP CONSTRAINT "operation_assignments_currency_code_fkey";

-- AlterTable
ALTER TABLE "cost_pools" ALTER COLUMN "variability" SET DEFAULT 'FIXED';

-- AlterTable
ALTER TABLE "deal_cost_lines" ADD COLUMN     "carrier_tariff_id" UUID,
ADD COLUMN     "tariff_amount" DECIMAL(18,4),
ADD COLUMN     "tariff_tolerance_pct" DECIMAL(6,3);

-- AlterTable
ALTER TABLE "operation_assignments" DROP COLUMN "carrier_tariff_id",
DROP COLUMN "currency_code",
DROP COLUMN "freight_cost",
DROP COLUMN "freight_variance_reason",
DROP COLUMN "fx_rate_to_pivot",
DROP COLUMN "tariff_amount",
DROP COLUMN "tariff_tolerance_pct";
...
BEGIN
  ...
  SELECT * INTO t FROM resolve_carrier_tariff(
    NEW.supplier_id, d.mode, d.product_id, NULL::uuid, d.site_id, CURRENT_DATE);
  ...
  attendu := CASE WHEN t.basis = 'PER_UNIT'
                  THEN t.amount * COALESCE(d.contracted_volume, 0)
                  ELSE t.amount END;
