...
-- AlterEnum
ALTER TYPE "field_event_type" ADD VALUE 'CHECK_REJECTED';

-- AlterTable
ALTER TABLE "cost_pools" ALTER COLUMN "variability" SET DEFAULT 'FIXED';

-- AlterTable
ALTER TABLE "operation_hse_checks" ADD COLUMN     "rejected_at" TIMESTAMPTZ(3),
ADD COLUMN     "rejected_by_field_user_id" UUID,
ADD COLUMN     "rejected_by_user_id" UUID,
ADD COLUMN     "rejection_reason" VARCHAR(1000);

-- AddForeignKey
ALTER TABLE "operation_hse_checks" ADD CONSTRAINT "operation_hse_checks_rejected_by_field_user_id_fkey" FOREIGN KEY ("rejected_by_field_user_id") REFERENCES "field_users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "operation_hse_checks" ADD CONSTRAINT "operation_hse_checks_rejected_by_user_id_fkey" FOREIGN KEY ("rejected_by_user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
