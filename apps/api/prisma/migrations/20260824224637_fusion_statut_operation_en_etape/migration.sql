...
-- CreateEnum
CREATE TYPE "operation_halt_type" AS ENUM ('INCIDENT', 'CANCELLED');

-- AlterEnum
--
-- CORRIGÉ À LA MAIN (§ 22/08/2026) — `prisma migrate diff` avait inclus ici
-- deux ALTER COLUMN sur des objets qui N'EXISTENT PAS ENCORE à ce point de la
-- migration : "operations"."phase" (créée plus bas par CREATE TABLE/ADD
-- COLUMN, cf. AlterTable "operations" et CreateTable
-- "operation_phase_transitions"). Seules les DEUX colonnes qui portaient
...
-- DropForeignKey
ALTER TABLE "field_sync_events" DROP CONSTRAINT "field_sync_events_operation_id_fkey";

-- DropForeignKey
ALTER TABLE "operation_status_transitions" DROP CONSTRAINT "operation_status_transitions_operation_id_fkey";

-- DropForeignKey
ALTER TABLE "operations" DROP CONSTRAINT "operations_hse_derogation_id_fkey";

-- DropForeignKey
ALTER TABLE "operations" DROP CONSTRAINT "operations_hse_validated_by_id_fkey";

-- DropForeignKey
ALTER TABLE "operations" DROP CONSTRAINT "operations_hse_validated_by_user_id_fkey";

-- DropIndex
DROP INDEX "operations_deal_id_status_idx";

-- DropIndex
DROP INDEX "operations_field_agent_id_status_idx";

-- DropIndex
DROP INDEX "operations_hse_derogation_id_key";

-- DropIndex
DROP INDEX "operations_hse_risk_level_status_idx";

-- DropIndex
DROP INDEX "operations_status_planned_loading_date_idx";

-- AlterTable
ALTER TABLE "cost_pools" ALTER COLUMN "variability" SET DEFAULT 'FIXED';

-- AlterTable
ALTER TABLE "operation_hse_checks" ADD COLUMN     "derogation_id" UUID;

-- AlterTable
--
-- CORRIGÉ À LA MAIN (§ 22/08/2026) — `prisma migrate diff` aurait DROP la
-- colonne "status" et ajouté "phase" NOT NULL DEFAULT 'PREPARATION' en une
-- seule passe : chaque opération existante (12 valeurs de statut possibles)
-- serait tombée sur PREPARATION sans distinction, perdant l'information
-- réelle. Colonnes ajoutées NULLABLES d'abord, peuplées depuis "status",
-- PUIS "phase" verrouillée NOT NULL, PUIS les anciennes colonnes déposées.
ALTER TABLE "operations"
ADD COLUMN     "halt_reason" VARCHAR(1000),
ADD COLUMN     "halt_type" "operation_halt_type",
ADD COLUMN     "halted_at" TIMESTAMPTZ(3),
ADD COLUMN     "halted_by_id" UUID,
ADD COLUMN     "phase" "operation_phase";

-- DataMigration — reprise des 12 valeurs de "status" vers "phase" + halte.
-- INCIDENT/CANCELLED n'ont pas de mémoire de l'étape quittée dans l'ancien
-- modèle (un statut plat) : repli documenté sur PREPARATION, sans
-- conséquence pratique aujourd'hui (aucune opération de ce lot en staging).
UPDATE "operations" SET
  "phase" = (CASE "status"::text
    WHEN 'DRAFT' THEN 'PREPARATION'
    WHEN 'SOURCING' THEN 'PREPARATION'
    WHEN 'HSE_PREPARATION' THEN 'PREPARATION'
    WHEN 'HSE_BLOCKED' THEN 'PREPARATION'
    WHEN 'PLANNED' THEN 'PRE_CHARGEMENT'
    WHEN 'LOADING' THEN 'CHARGEMENT'
    WHEN 'IN_TRANSIT' THEN 'TRANSPORT'
    WHEN 'DELIVERING' THEN 'DECHARGEMENT'
    WHEN 'FINAL_CHECK' THEN 'POST_DECHARGEMENT'
    WHEN 'CLOSED' THEN 'CLOTURE'
    WHEN 'INCIDENT' THEN 'PREPARATION'
    WHEN 'CANCELLED' THEN 'PREPARATION'
  END)::"operation_phase",
  "halt_type" = CASE WHEN "status"::text IN ('INCIDENT', 'CANCELLED') THEN "status"::text::"operation_halt_type" END,
  "halted_at" = CASE WHEN "status"::text IN ('INCIDENT', 'CANCELLED') THEN "updated_at" END,
  "halt_reason" = CASE WHEN "status"::text = 'CANCELLED' THEN "cancellation_reason" END
WHERE "status" IS NOT NULL;

ALTER TABLE "operations" ALTER COLUMN "phase" SET NOT NULL,
ALTER COLUMN "phase" SET DEFAULT 'PREPARATION';

ALTER TABLE "operations" DROP COLUMN "cancellation_reason",
DROP COLUMN "hse_derogation_id",
DROP COLUMN "hse_validated_at",
DROP COLUMN "hse_validated_by_id",
DROP COLUMN "hse_validated_by_user_id",
DROP COLUMN "status";

-- DropTable
DROP TABLE "operation_status_transitions";

-- DropEnum
DROP TYPE "operation_status";

-- CreateTable
CREATE TABLE "operation_phase_transitions" (
    "id" UUID NOT NULL,
    "operation_id" UUID NOT NULL,
    "from_phase" "operation_phase",
    "to_phase" "operation_phase" NOT NULL,
    ...
    CONSTRAINT "operation_phase_transitions_pkey" PRIMARY KEY ("id")
);

-- CreateIndex
CREATE INDEX "operation_phase_transitions_operation_id_created_at_idx" ON "operation_phase_transitions"("operation_id", "created_at");

-- CreateIndex
CREATE UNIQUE INDEX "operation_hse_checks_derogation_id_key" ON "operation_hse_checks"("derogation_id");

-- CreateIndex
CREATE INDEX "operations_deal_id_phase_idx" ON "operations"("deal_id", "phase");

-- CreateIndex
CREATE INDEX "operations_phase_planned_loading_date_idx" ON "operations"("phase", "planned_loading_date");

-- CreateIndex
CREATE INDEX "operations_field_agent_id_phase_idx" ON "operations"("field_agent_id", "phase");

-- CreateIndex
CREATE INDEX "operations_hse_risk_level_phase_idx" ON "operations"("hse_risk_level", "phase");

-- AddForeignKey
ALTER TABLE "field_sync_events" ADD CONSTRAINT "field_sync_events_operation_id_fkey" FOREIGN KEY ("operation_id") REFERENCES "operations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "operations" ADD CONSTRAINT "operations_halted_by_id_fkey" FOREIGN KEY ("halted_by_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "operation_phase_transitions" ADD CONSTRAINT "operation_phase_transitions_operation_id_fkey" FOREIGN KEY ("operation_id") REFERENCES "operations"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "operation_hse_checks" ADD CONSTRAINT "operation_hse_checks_derogation_id_fkey" FOREIGN KEY ("derogation_id") REFERENCES "derogations"("id") ON DELETE SET NULL ON UPDATE CASCADE;
