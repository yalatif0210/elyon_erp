-- CreateEnum
CREATE TYPE "cost_basis" AS ENUM ('PER_UNIT', 'FIXED');

-- AlterEnum
ALTER TYPE "derogation_type" ADD VALUE 'PURCHASE_PRICE_VARIANCE';

-- AlterTable
ALTER TABLE "deal_cost_lines" ADD COLUMN     "basis" "cost_basis" NOT NULL DEFAULT 'FIXED',
ADD COLUMN     "input_amount" DECIMAL(18,4) NOT NULL DEFAULT 0,
ADD COLUMN     "standard_amount" DECIMAL(18,4),
ADD COLUMN     "standard_basis" "cost_basis",
ADD COLUMN     "variance_reason" VARCHAR(500);

-- AlterTable
ALTER TABLE "deals" ADD COLUMN     "purchase_price_derogation_id" UUID,
ADD COLUMN     "purchase_price_variance_reason" VARCHAR(500);
...
CREATE TABLE "cost_standards" (
    ...
    CONSTRAINT "cost_standards_pkey" PRIMARY KEY ("id")
);

-- CreateIndex
CREATE INDEX "cost_standards_cost_post_id_effective_from_idx" ON "cost_standards"("cost_post_id", "effective_from" DESC);

-- CreateIndex
CREATE UNIQUE INDEX "cost_standards_cost_post_id_segment_transport_mode_product__key" ON "cost_standards"("cost_post_id", "segment", "transport_mode", "product_id", "effective_from");

-- CreateIndex
CREATE UNIQUE INDEX "deals_purchase_price_derogation_id_key" ON "deals"("purchase_price_derogation_id");

-- AddForeignKey
ALTER TABLE "deals" ADD CONSTRAINT "deals_purchase_price_derogation_id_fkey" FOREIGN KEY ("purchase_price_derogation_id") REFERENCES "derogations"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "cost_standards" ADD CONSTRAINT "cost_standards_cost_post_id_fkey" FOREIGN KEY ("cost_post_id") REFERENCES "cost_posts"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "cost_standards" ADD CONSTRAINT "cost_standards_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "cost_standards" ADD CONSTRAINT "cost_standards_currency_code_fkey" FOREIGN KEY ("currency_code") REFERENCES "currencies"("code") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "cost_standards" ADD CONSTRAINT "cost_standards_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
