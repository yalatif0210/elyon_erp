...
-- AlterEnum
ALTER TYPE "quotation_request_status" ADD VALUE 'PROFORMA_APPROVED';

-- AlterTable
ALTER TABLE "cost_pools" ALTER COLUMN "variability" SET DEFAULT 'FIXED';

-- AlterTable
ALTER TABLE "invoices" ADD COLUMN     "accepted_at" TIMESTAMPTZ(3),
ADD COLUMN     "accepted_by_portal_user_id" UUID,
ADD COLUMN     "quotation_request_id" UUID,
ALTER COLUMN "deal_id" DROP NOT NULL;

-- AlterTable
ALTER TABLE "quotation_requests" ADD COLUMN     "approved_proforma_id" UUID;

-- CreateIndex
CREATE UNIQUE INDEX "quotation_requests_approved_proforma_id_key" ON "quotation_requests"("approved_proforma_id");

-- AddForeignKey
ALTER TABLE "quotation_requests" ADD CONSTRAINT "quotation_requests_approved_proforma_id_fkey" FOREIGN KEY ("approved_proforma_id") REFERENCES "invoices"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "invoices" ADD CONSTRAINT "invoices_quotation_request_id_fkey" FOREIGN KEY ("quotation_request_id") REFERENCES "quotation_requests"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "invoices" ADD CONSTRAINT "invoices_accepted_by_portal_user_id_fkey" FOREIGN KEY ("accepted_by_portal_user_id") REFERENCES "portal_users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
