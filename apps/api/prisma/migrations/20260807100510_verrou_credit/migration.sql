-- AlterEnum
ALTER TYPE "derogation_type" ADD VALUE 'CREDIT_LIMIT_OVERRIDE';

-- AlterTable
ALTER TABLE "deals" ADD COLUMN     "credit_derogation_id" UUID;

-- CreateIndex
CREATE UNIQUE INDEX "deals_credit_derogation_id_key" ON "deals"("credit_derogation_id");

-- AddForeignKey
ALTER TABLE "deals" ADD CONSTRAINT "deals_credit_derogation_id_fkey" FOREIGN KEY ("credit_derogation_id") REFERENCES "derogations"("id") ON DELETE SET NULL ON UPDATE CASCADE;
