-- CreateEnum
CREATE TYPE "field_event_type" AS ENUM ('CHECK_OPENED', 'CHECK_ITEM_RECORDED', 'CHECK_VALIDATED', 'MEASUREMENT_RECORDED', 'STATUS_ADVANCED', 'HSE_EVENT_DECLARED');

-- CreateEnum
CREATE TYPE "field_event_status" AS ENUM ('ACCEPTED', 'REJECTED', 'DEFERRED');

-- CreateTable
CREATE TABLE "field_sync_events" (
    "id" UUID NOT NULL,
    "operation_id" UUID NOT NULL,
    "field_user_id" UUID NOT NULL,
    "device_id" VARCHAR(128) NOT NULL,
    "type" "field_event_type" NOT NULL,
    "payload" JSONB NOT NULL,
    "sequence" INTEGER NOT NULL,
    "device_timestamp" TIMESTAMPTZ(3) NOT NULL,
    "received_at" TIMESTAMPTZ(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "status" "field_event_status" NOT NULL,
    "rejection_reason" VARCHAR(1000),
    "applied_at" TIMESTAMPTZ(3),
    "latitude" DECIMAL(10,7),
    "longitude" DECIMAL(10,7),

    CONSTRAINT "field_sync_events_pkey" PRIMARY KEY ("id")
);

-- CreateIndex
CREATE INDEX "field_sync_events_operation_id_sequence_idx" ON "field_sync_events"("operation_id", "sequence");

-- CreateIndex
CREATE INDEX "field_sync_events_status_received_at_idx" ON "field_sync_events"("status", "received_at");

-- CreateIndex
CREATE INDEX "field_sync_events_field_user_id_received_at_idx" ON "field_sync_events"("field_user_id", "received_at");

-- AddForeignKey
ALTER TABLE "field_sync_events" ADD CONSTRAINT "field_sync_events_operation_id_fkey" FOREIGN KEY ("operation_id") REFERENCES "operations"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "field_sync_events" ADD CONSTRAINT "field_sync_events_field_user_id_fkey" FOREIGN KEY ("field_user_id") REFERENCES "field_users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
