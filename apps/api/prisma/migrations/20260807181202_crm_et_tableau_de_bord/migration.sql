-- CreateEnum
CREATE TYPE "crm_stage_outcome" AS ENUM ('OPEN', 'WON', 'LOST', 'DORMANT');

-- CreateEnum
CREATE TYPE "crm_interaction_kind" AS ENUM ('CALL', 'EMAIL', 'MEETING', 'VISIT', 'MESSAGE', 'OFFER', 'REPORT', 'DOCUMENT', 'COMPLAINT');
...
CREATE TABLE "crm_opportunities" (
    ...
    "product_id" UUID,
    "estimated_volume" DECIMAL(18,4) NOT NULL,
    "uom" "unit_of_measure" NOT NULL,
    "reference_price" DECIMAL(18,4) NOT NULL,
    "currency_code" CHAR(3) NOT NULL,
    "stage_id" UUID NOT NULL,
    "probability_override_pct" DECIMAL(5,2),
...
CREATE TABLE "crm_stage_transitions" (
    ...
    "probability_at_pct" DECIMAL(5,2),
    "weighted_value_at" DECIMAL(18,4),
    "note" VARCHAR(500),
...
-- CreateIndex
CREATE UNIQUE INDEX "crm_pipeline_stages_code_key" ON "crm_pipeline_stages"("code");

-- CreateIndex
CREATE UNIQUE INDEX "crm_pipeline_stages_rank_key" ON "crm_pipeline_stages"("rank");

-- CreateIndex
CREATE UNIQUE INDEX "crm_opportunities_reference_key" ON "crm_opportunities"("reference");

-- CreateIndex
CREATE UNIQUE INDEX "crm_opportunities_deal_id_key" ON "crm_opportunities"("deal_id");
...
-- CreateIndex
CREATE INDEX "crm_opportunities_partner_id_idx" ON "crm_opportunities"("partner_id");

-- CreateIndex
CREATE INDEX "crm_opportunities_next_action_due_idx" ON "crm_opportunities"("next_action_due");

-- CreateIndex
CREATE INDEX "crm_stage_transitions_opportunity_id_occurred_at_idx" ON "crm_stage_transitions"("opportunity_id", "occurred_at");

-- CreateIndex
CREATE INDEX "crm_interactions_opportunity_id_occurred_at_idx" ON "crm_interactions"("opportunity_id", "occurred_at");

-- CreateIndex
CREATE INDEX "crm_interactions_next_action_due_next_action_done_idx" ON "crm_interactions"("next_action_due", "next_action_done");

-- AddForeignKey
ALTER TABLE "crm_opportunities" ADD CONSTRAINT "crm_opportunities_partner_id_fkey" FOREIGN KEY ("partner_id") REFERENCES "partners"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "crm_opportunities" ADD CONSTRAINT "crm_opportunities_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "crm_opportunities" ADD CONSTRAINT "crm_opportunities_currency_code_fkey" FOREIGN KEY ("currency_code") REFERENCES "currencies"("code") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "crm_opportunities" ADD CONSTRAINT "crm_opportunities_deal_id_fkey" FOREIGN KEY ("deal_id") REFERENCES "deals"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "crm_stage_transitions" ADD CONSTRAINT "crm_stage_transitions_opportunity_id_fkey" FOREIGN KEY ("opportunity_id") REFERENCES "crm_opportunities"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "crm_stage_transitions" ADD CONSTRAINT "crm_stage_transitions_from_stage_id_fkey" FOREIGN KEY ("from_stage_id") REFERENCES "crm_pipeline_stages"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "crm_stage_transitions" ADD CONSTRAINT "crm_stage_transitions_to_stage_id_fkey" FOREIGN KEY ("to_stage_id") REFERENCES "crm_pipeline_stages"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "crm_interactions" ADD CONSTRAINT "crm_interactions_opportunity_id_fkey" FOREIGN KEY ("opportunity_id") REFERENCES "crm_opportunities"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "crm_interactions" ADD CONSTRAINT "crm_interactions_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
WITH prevu AS (
  SELECT s.fiscal_year_id,
         ...
         round(sum(s.forecast_volume * s.reference_price), 2)     AS ca_prevu,
         s.currency_code,
         s.uom
    FROM sales_forecasts s
    JOIN fiscal_years f ON f.id = s.fiscal_year_id
   WHERE s.is_current
   GROUP BY s.fiscal_year_id, f.year, s.segment, s.product_id, s.currency_code, s.uom
),
realise AS (
...
BEGIN
  ...
  INSERT INTO crm_stage_transitions
    (id, opportunity_id, from_stage_id, to_stage_id,
     probability_at_pct, weighted_value_at, occurred_at)
  VALUES
...
-- L'historique ne se réécrit pas : il sert à mesurer la conversion.
...
CREATE TRIGGER trg_crm_transitions_no_update
  BEFORE UPDATE OR DELETE ON crm_stage_transitions
  FOR EACH STATEMENT EXECUTE FUNCTION append_only_guard();
...
BEGIN
  ...
  -- L'historique des passages d'étape se lit et s'ajoute, jamais ne se réécrit.
  EXECUTE 'REVOKE UPDATE, DELETE, TRUNCATE ON crm_stage_transitions FROM erp_app';
