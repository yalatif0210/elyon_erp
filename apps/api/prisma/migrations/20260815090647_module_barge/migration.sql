...
-- CreateEnum
CREATE TYPE "vehicle_maintenance_type" AS ENUM ('PREVENTIVE', 'CORRECTIVE', 'REGULATORY');
...
-- CreateIndex
CREATE INDEX "vehicle_maintenance_events_vehicle_id_performed_at_idx" ON "vehicle_maintenance_events"("vehicle_id", "performed_at" DESC);

-- CreateIndex
CREATE INDEX "vehicle_maintenance_events_next_due_at_idx" ON "vehicle_maintenance_events"("next_due_at");

-- AddForeignKey
ALTER TABLE "vehicle_maintenance_events" ADD CONSTRAINT "vehicle_maintenance_events_vehicle_id_fkey" FOREIGN KEY ("vehicle_id") REFERENCES "vehicles"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "vehicle_maintenance_events" ADD CONSTRAINT "vehicle_maintenance_events_currency_code_fkey" FOREIGN KEY ("currency_code") REFERENCES "currencies"("code") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "vehicle_maintenance_events" ADD CONSTRAINT "vehicle_maintenance_events_recorded_by_id_fkey" FOREIGN KEY ("recorded_by_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
