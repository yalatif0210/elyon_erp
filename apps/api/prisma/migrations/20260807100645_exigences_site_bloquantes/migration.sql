-- CreateTable
CREATE TABLE "operation_site_requirement_acks" (
    "id" UUID NOT NULL,
    "operation_id" UUID NOT NULL,
    "requirement_id" UUID NOT NULL,
    "note" VARCHAR(500),
    "acknowledged_by_id" UUID NOT NULL,
    "acknowledged_at" TIMESTAMPTZ(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "operation_site_requirement_acks_pkey" PRIMARY KEY ("id")
);

-- CreateIndex
CREATE UNIQUE INDEX "operation_site_requirement_acks_operation_id_requirement_id_key" ON "operation_site_requirement_acks"("operation_id", "requirement_id");

-- AddForeignKey
ALTER TABLE "operation_site_requirement_acks" ADD CONSTRAINT "operation_site_requirement_acks_operation_id_fkey" FOREIGN KEY ("operation_id") REFERENCES "operations"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "operation_site_requirement_acks" ADD CONSTRAINT "operation_site_requirement_acks_requirement_id_fkey" FOREIGN KEY ("requirement_id") REFERENCES "delivery_site_requirements"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "operation_site_requirement_acks" ADD CONSTRAINT "operation_site_requirement_acks_acknowledged_by_id_fkey" FOREIGN KEY ("acknowledged_by_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
