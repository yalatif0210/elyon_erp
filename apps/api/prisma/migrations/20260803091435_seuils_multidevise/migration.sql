-- DropIndex
DROP INDEX "margin_thresholds_segment_effective_from_idx";

-- DropIndex
DROP INDEX "margin_thresholds_segment_product_id_effective_from_key";

-- CreateIndex
CREATE INDEX "margin_thresholds_segment_currency_code_uom_effective_from_idx" ON "margin_thresholds"("segment", "currency_code", "uom", "effective_from" DESC);

-- CreateIndex
CREATE UNIQUE INDEX "margin_thresholds_segment_product_id_currency_code_uom_effe_key" ON "margin_thresholds"("segment", "product_id", "currency_code", "uom", "effective_from");
