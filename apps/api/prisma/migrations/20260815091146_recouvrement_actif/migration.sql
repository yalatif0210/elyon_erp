...
-- CreateEnum
CREATE TYPE "dunning_method" AS ENUM ('PHONE', 'EMAIL', 'LETTER', 'VISIT', 'OTHER');
...
-- CreateIndex
CREATE INDEX "dunning_actions_invoice_id_contacted_at_idx" ON "dunning_actions"("invoice_id", "contacted_at" DESC);
...
-- AddForeignKey
ALTER TABLE "dunning_actions" ADD CONSTRAINT "dunning_actions_recorded_by_id_fkey" FOREIGN KEY ("recorded_by_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
